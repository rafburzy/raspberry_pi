...
NotebookDataLength[     99481,       1913]
NotebookOptionsPosition[     98516,       1859]
NotebookOutlinePosition[     98851,       1874]
CellTagsIndexPosition[     98808,       1871]
WindowFrame->Normal*)
...
Cell[BoxData["5"], "Output",
 CellChangeTimes->{
  3.629470668418762*^9, 3.6294734375697193`*^9, 3.629473561937174*^9, {
   ...
   3.6294787099167233`*^9, 3.650129364842852*^9}],
...
Cell[BoxData["0.1`"], "Output",
 CellChangeTimes->{
  3.629470668418762*^9, 3.6294734375697193`*^9, 3.629473561937174*^9, {
   ...
   3.629476121464336*^9, 3.629476170497839*^9, 3.629476319872239*^9, 
   3.629476432280648*^9, 3.629476477461705*^9, 3.629478259372923*^9, 
   3.6294787099167233`*^9, 3.6501293649194717`*^9}],

Cell[BoxData[
 RowBox[{"0.6283185307179586`", " ", "f"}]], "Output",
 CellChangeTimes->{
  3.629470668418762*^9, 3.6294734375697193`*^9, 3.629473561937174*^9, {
   3.629473838289357*^9, 3.6294738590817947`*^9}, 3.629473898938837*^9, 
   3.629473978602191*^9, 3.629474438997993*^9, 3.629474482398073*^9, 
   ...
   3.629476121464336*^9, 3.629476170497839*^9, 3.629476319872239*^9, 
   3.629476432280648*^9, 3.629476477461705*^9, 3.629478259372923*^9, 
   3.6294787099167233`*^9, 3.650129364948807*^9}],

Cell[BoxData[
 RowBox[{"ArcTan", "[", 
  RowBox[{"0.12566370614359174`", " ", "f"}], "]"}]], "Output",
 CellChangeTimes->{
  3.629470668418762*^9, 3.6294734375697193`*^9, 3.629473561937174*^9, {
   3.629473838289357*^9, 3.6294738590817947`*^9}, 3.629473898938837*^9, 
   3.629473978602191*^9, 3.629474438997993*^9, 3.629474482398073*^9, 
   ...
   3.629476121464336*^9, 3.629476170497839*^9, 3.629476319872239*^9, 
   3.629476432280648*^9, 3.629476477461705*^9, 3.629478259372923*^9, 
   3.6294787099167233`*^9, 3.650129364974032*^9}],

Cell[BoxData[
 FractionBox["1", 
  SqrtBox[
   RowBox[{"1", "+", 
    RowBox[{"0.015791367041742974`", " ", 
 ...
 CellChangeTimes->{
  3.629470668418762*^9, 3.6294734375697193`*^9, 3.629473561937174*^9, {
   ...
   3.629476121464336*^9, 3.629476170497839*^9, 3.629476319872239*^9, 
   3.629476432280648*^9, 3.629476477461705*^9, 3.629478259372923*^9, 
   3.6294787099167233`*^9, 3.6501293649987907`*^9}]
}, Open  ]],
...
Cell[BoxData["50"], "Output",
 CellChangeTimes->{3.629470664509924*^9, 3.629473860223654*^9, 
  ...
  3.62947871108014*^9, 3.6501293704152308`*^9}]
}, Open  ]],
...
Cell[BoxData["0"], "Output",
 CellChangeTimes->{
  3.6294705295397367`*^9, 3.629473861307403*^9, 3.629473900523162*^9, 
   ...
   3.6294782630442553`*^9, 3.6294787121728067`*^9, 3.65012937164355*^9}]
}, Open  ]],
...
Cell[BoxData["230"], "Output",
 CellChangeTimes->{3.629470781896134*^9, 3.629473862475554*^9, 
  ...
  3.629478583254877*^9, 3.629478713279368*^9, 3.65012937388197*^9}],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.629470781896134*^9, 3.629473862475554*^9, 
  ...
  3.62947595229169*^9, 3.6294760068321533`*^9, 3.629476171900326*^9, 
  3.629476435894641*^9, 3.629476480234174*^9, 3.629478264617091*^9, 
  3.629478583254877*^9, 3.629478713279368*^9, 3.6501293739030313`*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.6294743084394093`*^9, 3.629474443594961*^9, 
  ...
  3.629478714361721*^9, 3.650129376060546*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.6294743424888573`*^9, 3.629474443776824*^9, 
  ...
  3.629478715377561*^9, 3.6501293774181957`*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.629474562689966*^9, 3.629474950255117*^9, 
  ...
  3.629478269329509*^9, 3.629478716416305*^9, 3.650129378775134*^9}]
}, Open  ]],
...
ZsveT6Kv59/9H9+Kpsg=
 ...
 CellChangeTimes->{3.6294733002838097`*^9, 3.6294733482121067`*^9, 
  ...
  3.629479789961896*^9, 
  3.650129381994884*^9},ImageCache->GraphicsData["CompressedBitmap", "\<\
...
Cell[BoxData["0.020000000000000004`"], "Output",
 CellChangeTimes->{3.629474809454748*^9, 3.629474961282091*^9, 
  ...
  3.6294787192145863`*^9, 3.650129384531592*^9}]
}, Open  ]],
...
YySEHVxhHalAxux1YjCFxMqAOEeeRIH/AG+pRLA=
 ...
 CellChangeTimes->{3.6294791074871693`*^9, 3.629479423971182*^9, 
  3.629479575377684*^9, 3.650129392766643*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.6294748619744463`*^9, 3.629474881911765*^9}, {
  ...
  3.6501294365568123`*^9, 3.650129468601061*^9}}],
...
Cell[BoxData[
   ...
   DynamicModuleBox[{$CellContext`a$$ = 0, Typeset`show$$ = True, 
    ...
    Initialization:>({$CellContext`i[
         Pattern[$CellContext`t, 
          Blank[]], 
         Pattern[$CellContext`alfa, 
          Blank[]]] = {
        10.224947015550818` (
          Sin[1.4129651365067377` - $CellContext`alfa]/E^(50. $CellContext`t) - 
          Sin[1.4129651365067377` - $CellContext`alfa - 100 
           Pi $CellContext`t])}, $CellContext`iu[
         Pattern[$CellContext`t, 
          Blank[]], 
         Pattern[$CellContext`alfa, 
          Blank[]]] = (-10.224947015550818`) 
        Sin[1.4129651365067377` - $CellContext`alfa - 100 
          Pi $CellContext`t], $CellContext`idc[
         Pattern[$CellContext`t, 
          Blank[]], 
         Pattern[$CellContext`alfa, 
          Blank[]]] = {(10.224947015550818` 
          Sin[1.4129651365067377` - $CellContext`alfa])/
         E^(50. $CellContext`t)}}; Typeset`initDone$$ = True),
 ...
 CellChangeTimes->{3.629474883777917*^9, 3.6294749639547567`*^9, 
  ...
  3.6294788510134583`*^9, 3.629479054602297*^9, 3.650129397802256*^9, 
  3.650129478987277*^9}]
}, Open  ]]
},
WindowSize->{810, 718},
WindowMargins->{{346, Automatic}, {Automatic, 31}},
...
Cell[2818, 62, 737, 11, 32, "Output"],
Cell[3558, 75, 742, 11, 32, "Output"],
Cell[4303, 88, 777, 12, 32, "Output"],
Cell[5083, 102, 811, 13, 32, "Output"],
Cell[5897, 117, 867, 16, 55, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[6801, 138, 126, 2, 32, "Input"],
Cell[6930, 142, 490, 7, 32, "Output"]
}, Open  ]],
Cell[7435, 152, 95, 1, 33, "Text"],
Cell[CellGroupData[{
Cell[7555, 157, 374, 6, 32, "Input"],
Cell[7932, 165, 554, 8, 32, "Output"]
}, Open  ]],
Cell[8501, 176, 102, 1, 33, "Text"],
Cell[CellGroupData[{
Cell[8628, 181, 529, 13, 55, "Input"],
Cell[9160, 196, 514, 7, 32, "Output"],
Cell[9677, 205, 659, 12, 36, "Output"]
}, Open  ]],
Cell[10351, 220, 109, 1, 33, "Text"],
Cell[CellGroupData[{
Cell[10485, 225, 1119, 30, 55, "Input"],
Cell[11607, 257, 925, 21, 32, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[12569, 283, 566, 16, 32, "Input"],
Cell[13138, 301, 626, 11, 32, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[13801, 317, 743, 23, 32, "Input"],
Cell[14547, 342, 639, 13, 32, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[15223, 360, 859, 16, 32, "Input"],
Cell[16085, 378, 16226, 277, 221, 9747, 170, "CachedBoxData", "BoxData", \
"Output"]
}, Open  ]],
Cell[32326, 658, 95, 1, 33, "Text"],
Cell[CellGroupData[{
Cell[32446, 663, 117, 2, 32, "Input"],
Cell[32566, 667, 446, 6, 32, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[33049, 678, 958, 24, 77, "Input"],
Cell[34010, 704, 60122, 1054, 220, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[94169, 1763, 1220, 28, 77, "Input"],
Cell[95392, 1793, 3108, 63, 308, "Output"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature bxTxeOS2NELGVBK4PPZPAxd7 *)
